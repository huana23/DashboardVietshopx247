function MetricCard({ title, icon, value, suffix, statusText, statusColor, progress, pulse }) {
  return (
    <article
      className={`h-full min-h-24 flex flex-col rounded-xl bg-surface-container p-4 lg:p-6 transition-colors hover:bg-surface-container-high ${pulse ? "metric-pulse" : ""}`}
    >
